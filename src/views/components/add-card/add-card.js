...
const buttonAddCardToCompate = $('.add-card-component .button-add-card');
...
function checkToDeactiveCardOption() {
  ...
  if (chosenCreditCard === MAXIMUM_NUMBER_OF_CARD) {
    ...
    buttonAddCardToCompate.addClass('remove-class-add-card');
  } else {
    buttonAddCardToCompate.removeClass('remove-class-add-card');
  }
}
